...
from course_discovery.apps.api.v1.views.program_extend import ProgramEliteExtendViewSet
...
router.register(r'program_extend', ProgramEliteExtendViewSet, base_name='program_extend')
